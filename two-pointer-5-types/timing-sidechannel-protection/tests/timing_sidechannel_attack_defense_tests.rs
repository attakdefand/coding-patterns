...
fn test_timing_attack_resistance_string_compare() {
    ...
    assert!(
        ratio < 10.0,
        "Potential timing leak detected: max/min ratio = {}",
        ratio
    );
...
fn test_timing_attack_resistance_two_sum() {
    ...
    assert!(
        ratio < 10.0,
        "Potential timing leak in two-sum: {} vs {}",
        time1,
        time2
    );
...
fn test_timing_attack_resistance_array_search() {
    ...
    assert!(
        ratio < 10.0,
        "Potential timing leak in array search: max/min ratio = {}",
        ratio
    );
...
fn test_timing_attack_resistance_intersection() {
    ...
    assert!(
        ratio < 10.0,
        "Potential timing leak in intersection: {} vs {}",
        time1,
        time2
    );
...
fn test_statistical_timing_resistance() {
    ...
    assert!(
        diff_ratio < 2.0,
        "Statistical timing difference detected: wrong={}ns, correct={}ns",
        avg_wrong,
        avg_correct
    );
}
