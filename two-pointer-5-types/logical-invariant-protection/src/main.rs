...
fn main() {
    ...
    match two_sum_sorted(&nums, 9) {
        Some((i, j)) => println!("two_sum_sorted (sorted): Found indices {} and {} for target 9", i, j),
    ...
    match two_sum_sorted(&nums, 9) {
        Some((i, j)) => println!("two_sum_sorted (unsorted): Found indices {} and {} for target 9", i, j),
    ...
    match three_sum(&nums, 0) {
        Some((i, j, k)) => println!("three_sum (sorted): Found indices {}, {}, and {} for target 0", i, j, k),
    ...
    match three_sum(&nums, 0) {
        Some((i, j, k)) => println!("three_sum (unsorted): Found indices {}, {}, and {} for target 0", i, j, k),
